...
bool parse<bool>(std::string_view value) {
  ...
  throw InvalidArgumentError() << "Invalid boolean argument value: " << value;
}

// -------------------------------------------------------------------------- //

#define _WOOF_NUM_PARSE_DEFINE(NUM)                                     \
  template <>                                                           \
...
_WOOF_NUM_PARSE_DEFINE(short);
_WOOF_NUM_PARSE_DEFINE(int);
_WOOF_NUM_PARSE_DEFINE(long int);
_WOOF_NUM_PARSE_DEFINE(long long int);
_WOOF_NUM_PARSE_DEFINE(unsigned short);
_WOOF_NUM_PARSE_DEFINE(unsigned int);
_WOOF_NUM_PARSE_DEFINE(unsigned long int);
_WOOF_NUM_PARSE_DEFINE(unsigned long long int);

#undef _WOOF_NUM_PARSE_DEFINE
